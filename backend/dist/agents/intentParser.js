...
const romanUrduMap = JSON.parse(fs.readFileSync(path.join(currDir, "../../data/roman_urdu_map.json"), "utf-8"));
...
export async function parseIntent(userInput, history = []) {
