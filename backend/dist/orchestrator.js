...
import { createNegotiationThread, customerRespond, getThread } from "./agents/negotiationAgent.js";
...
async function parseNegotiationInput(userInput, aiQuote) {
    ...
    try {
        ...
        const result = await model.generateContent(`Pakistani home service negotiation. AI quoted Rs. ${aiQuote}. Customer said: "${userInput}". Classify as accept/decline/counter. If counter, extract PKR price.\nReturn JSON: {"action":"accept"|"decline"|"counter","price":number|null}`);
